...
final class TPPContentBadgeImageView: UIImageView {
  ...
  @objc class func pin(badge: UIImageView, toView view: UIView, isLane: Bool) {
    ...
    if(!isLane) {
      badge.autoPinEdge(.trailing, to: .trailing, of: view, withOffset: 18)
      badge.autoPinEdge(.bottom, to: .bottom, of: view, withOffset: 6)
    } else {
      badge.autoPinEdge(.trailing, to: .trailing, of: view, withOffset: 2)
      badge.autoPinEdge(.bottom, to: .bottom, of: view, withOffset: -4)
    }
  }
}
